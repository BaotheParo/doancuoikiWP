...
namespace SOSIDEE_DYNAMIC_QRCODE\SOS\LIBS\Detection;
defined( 'SOSIDEE_DYNAMIC_QRCODE' ) or die( 'you were not supposed to be here' );


use BadMethodCallException;
use SOSIDEE_DYNAMIC_QRCODE\SOS\LIBS\Detection\Cache\Cache;
use SOSIDEE_DYNAMIC_QRCODE\SOS\LIBS\Detection\Cache\CacheException;
use SOSIDEE_DYNAMIC_QRCODE\SOS\LIBS\Detection\Exception\MobileDetectException;
use SOSIDEE_DYNAMIC_QRCODE\SOS\LIBS\Psr\Cache\InvalidArgumentException;
